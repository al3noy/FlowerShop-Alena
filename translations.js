const translations = {
    sr: {
        ...
        team:"Naš tim",
        titlecvec: "Izdvajamo za vas, naše najbolje usluge",
        btnpocetna:"Nazad na početnu",
        exc: "Izdvajamo za vas",
        exctext:"Ponuda je trenutno aktivna u cvećari",
        redovno:"Redovne usluge",
        types:"Tipovi cveća koje prodajemo – buketi, aranžmani i ukrasno cveće po vašoj želji.",
        popular: "POPULARNO",
        roses:"Ruže",
        rosestext:"Buketi i aranžmani u raznim bojama",
        buket:"Buketi",
        bukettext: "Prolećni buketi i kompozicije",
        xlbuket:"XL Buketi",
        xlbukettext:"Veliko cveće i buketi",
        box:" Box aranžmani",
        boxtext:"Elegantni box za sve prilike",
        personal:"Personalizovani buket/aranžman",
        personaltext:"Personalizovani detalji po vašoj želji",
        rodj:"Rođendani",
        rodjtext:"Veseli aranžmani",
        new:"NOVO",
        auti: "Dekoracija vozila",
        autitext:"Po vašoj specijalnoj potrebi",
        prostor:"Dekoracija prostora",
        prostortext: "Po vašoj želji i prilici",
        gallery:"Galerija naših proizvoda",
        gallerytext:"Izaberite vaš ukras već danas."
    },
    sk: {
        ...
        team: "Náš tím",
        titlecvec: "Vyzdvihujeme pre vás naše najlepšie služby",
        btnpocetna:"Späť na domovskú stránku",
        exc: "Hlavné body pre vás",
        exctext:"Ponuka je momentálne aktívna v kvetinárstve",
        redovno:"Pravidelné služby",
        types: "Druhy kvetov, ktoré predávame - kytice, aranžmány a dekoratívne kvety podľa vášho želania.",
        popular :"POPULÁRNE",
        roses:"Ruže",
        rosestext:"Kytice a aranžmány v rôznych farbách",
        buket:"Kytice",
        bukettext:"Jarné kytice a kompozície",
        xlbuket:"XL Kytice",
        xlbukettext:"Veľké kvety a kytice",
        personal:"Personalizovaná kytica/aranžmán",
        personaltext:"Personalizované detaily podľa vašich predstáv",
        rodj:"Narodeniny",
        rodjtext:"Veselé aranžmány",
        new:"NOVÉ",
        auti:"Dekorácia vozidla",
        autitext:"Podľa vašej špeciálnej potreby",
        prostor:"Výzdoba izby",
        prostortext:"Na vašu žiadosť a príležitosť",
        gallery:"Galéria našich produktov",
        gallerytext:"Vyberte si svoju dekoráciu ešte dnes."
    }
};
